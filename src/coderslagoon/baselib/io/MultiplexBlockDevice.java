package coderslagoon.baselib.io;
...
public final class MultiplexBlockDevice implements BlockDevice {
    ...
    /** @see coderslagoon.baselib.io.BlockDevice#blockSize() */
    public int blockSize() {
        return this.bdev.blockSize();
    }

    /** @see coderslagoon.baselib.io.BlockDevice#readOnly() */
    public boolean readOnly() {
        return this.bdev.readOnly();
    }

    /** @see coderslagoon.baselib.io.BlockDevice#serialWrite() */
    public boolean serialWrite() {
        return this.bdev.serialWrite();
    }

    /** @see coderslagoon.baselib.io.BlockDevice#size() */
    public long size() {
        return this.bdev.size();
    }

    /** @see coderslagoon.baselib.io.BlockDevice#writeOnly() */
    ...
    /** @see coderslagoon.baselib.io.BlockDevice#write(long, byte[], int) */
    ...
    /** @see coderslagoon.baselib.io.BlockDevice#read(long, byte[], int) */
