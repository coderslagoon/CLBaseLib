...
import coderslagoon.baselib.util.CompactMap;
...
public abstract class FileNode implements Taggable {
    ...
    /** @see coderslagoon.baselib.util.Taggable#getTag(java.lang.String) */
    public Object getTag(String name) {
        return this.tags.get(name);
    }

    /** @see coderslagoon.baselib.util.Taggable#setTag(java.lang.String, java.lang.Object) */
    ...
    public boolean equals(Object obj) {
        if (obj instanceof FileNode) {
            return fileSystem().areNodesEqual(this, (FileNode)obj, true, true);
        }
        return false;
    }
